"""
Django settings for ap_model_new project.
...
SECRET_KEY = 'nl0=o*&fixiwu$(p_8k@7+6^=rnx$0#=7=s_fvqyc-6%uoa-nc'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['https://popog.azurewebsites.net', 'localhost']
...
ROOT_URLCONF = 'ap_model_new.urls'
...
WSGI_APPLICATION = 'ap_model_new.wsgi.application'
